...
export type BuiltRoutesBag <ExactRouteDefinerBag extends RouteDefinerBag, ConcreteClient extends Client<unknown>> = {
    [key in keyof ExactRouteDefinerBag]: ((...params: Parameters<ExactRouteDefinerBag[key]>) => (
